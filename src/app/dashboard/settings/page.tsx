    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'interview' && (
          <Card className="border-0 shadow-lg bg-gradient-to-br from-white to-slate-50">
            <CardHeader>
              <CardTitle className="text-xl text-slate-900">Interview Preferences</CardTitle>
              <CardDescription className="text-slate-600">
            ...
            <CardContent className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Select value={interviewSettings.defaultDuration} onValueChange={(value) => setInterviewSettings({ ...interviewSettings, defaultDuration: value })}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={interviewSettings.defaultQuestions} onValueChange={(value) => setInterviewSettings({ ...interviewSettings, defaultQuestions: value })}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={interviewSettings.difficulty} onValueChange={(value) => setInterviewSettings({ ...interviewSettings, difficulty: value })}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    {['technical', 'behavioral', 'problem-solving', 'leadership'].map((category) => (
                      <label key={category} className="flex items-center space-x-2">
                        <input
                          type="checkbox"
                          checked={interviewSettings.categories.includes(category)}
                          onChange={(e) => {
                            if (e.target.checked) {
                              setInterviewSettings({
                                ...interviewSettings,
                                categories: [...interviewSettings.categories, category]
                              });
                            } else {
                              setInterviewSettings({
                                ...interviewSettings,
                                categories: interviewSettings.categories.filter(c => c !== category)
                              });
                            }
                          }}
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                {[
                  ...
                  { key: 'weeklyReports', label: 'Weekly Progress Reports', description: 'Get a summary of your weekly performance' },
                  { key: 'achievementAlerts', label: 'Achievement Alerts', description: 'Get notified when you unlock achievements' },
                  { key: 'reminderEmails', label: 'Practice Reminders', description: 'Receive reminders to practice regularly' }
                ].map((setting) => (
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="p-4 bg-slate-50 rounded-lg">
                  ...
                  <p className="text-sm text-slate-600 mb-4">Update your account password for better security</p>
                ...
                <div className="p-4 bg-slate-50 rounded-lg">
                  ...
                  <Badge className="bg-orange-100 text-orange-800 border-orange-200">Not Enabled</Badge>
                  <Button variant="outline" className="ml-4 border-slate-300 hover:border-slate-400">
                    Enable 2FA
                  </Button>
                </div>
                
                <div className="p-4 bg-slate-50 rounded-lg">
                  <h4 className="font-medium text-slate-900 mb-2">Account Deletion</h4>
                  <p className="text-sm text-slate-600 mb-4">Permanently delete your account and all associated data</p>
                  <Button variant="outline" className="border-red-300 text-red-600 hover:border-red-400 hover:text-red-700">
                    Delete Account
                  </Button>
                </div>
              </div>
